...
public class ScoreUtilsTest {
  ...
  public void testValidScoreToNumericValue() {
    ...
    assertEquals(5, ScoreUtils.parseToNumericScore(testValue));
  }
  ...
  public void testEmptyInputScoreShouldReturnZero() {
    ...
    assertEquals(0, ScoreUtils.parseToNumericScore(testValue));
  }
  ...
  public void testAllValidNumberInputScores() {
    for (int i = 0; i < 11; i++) {
      ...
      assertEquals(i, ScoreUtils.parseToNumericScore(testValue));
    }
  }
  ...
  public void testMaxBorderCases() {
    String testValue = "10";
    assertEquals(10, ScoreUtils.parseToNumericScore(testValue));
